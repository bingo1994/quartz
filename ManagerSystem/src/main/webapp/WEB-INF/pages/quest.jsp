...
<div id="addDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3 ">
			<select class="form-control form-control-static" placeholder="请选择请假类型">
			...
			<div class="col-md-3">
			<textarea rows="3" id="user_address" name="user_address" cols="32" class="form-control form-control-static" placeholder="请填写请假原因"></textarea>
			</div>
			</div>
			...
			<div class="col-md-3">
			<input type="text" class="form-control form-control-static" placeholder="请选择开始时间">
			</div>
			</div>
			...
			<div class="col-md-3">
			<input type="text" class="form-control form-control-static" placeholder="请选择结束	时间">
			</div>
			</div>
			...
			<div class="col-md-3">
			<textarea rows="3" id="user_address" name="user_address" cols="32" class="form-control form-control-static" ></textarea>
			</div>
			</div>
